      ...
      >
        ...
        >
          <h2 className="text-2xl md:text-3xl font-extrabold font-poppins text-center mb-6 text-white tracking-tight drop-shadow-sm">Tech Stack</h2>
           b applications and UI experiments that emphasize accessibility, performance and visual polish. Below are highlights from my work — open-source tools, product interfaces and prototypes that solve real problems.
        </p>
      </section>
